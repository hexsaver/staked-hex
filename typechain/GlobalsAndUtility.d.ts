...
interface GlobalsAndUtilityInterface extends ethers.utils.Interface {
  functions: {
...
export class GlobalsAndUtility extends Contract {
  ...
  interface: GlobalsAndUtilityInterface;
