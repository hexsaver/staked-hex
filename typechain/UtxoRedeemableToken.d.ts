...
interface UtxoRedeemableTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class UtxoRedeemableToken extends Contract {
  ...
  interface: UtxoRedeemableTokenInterface;
